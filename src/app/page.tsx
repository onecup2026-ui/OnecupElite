...
import { Target, Zap, Star, Loader2, Trophy, Ticket, ExternalLink, ShieldCheck, ChevronRight, Calendar, MapPin } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[9px] text-muted-foreground font-medium">Standard FIFA.</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 md:w-8 md:h-8 shrink-0 bg-[#0051a3]/10 rounded-lg flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-[9px] text-muted-foreground font-medium">Stats temps réel.</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 md:w-8 md:h-8 shrink-0 bg-[#0051a3]/10 rounded-lg flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-[9px] text-muted-foreground font-medium">Visibilité max.</p>
              </div>
            </div>
          </div>
        </div>
